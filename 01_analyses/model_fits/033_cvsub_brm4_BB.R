...
cvsub_brm4_BB <- kfold(brm4_e1h1_BB, K = 10, folds = basket_conf_data_prereg$fold_pp, save_fits = TRUE)
if(!file.exists(here::here("01_analyses/fitted_models/033_cvsub_brm4_BB_lite.rds"))){
  saveRDS(cvsub_brm4_BB, here::here("01_analyses/fitted_models/033_cvsub_brm4_BB_lite.rds"))
}