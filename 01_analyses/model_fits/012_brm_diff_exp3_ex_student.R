...
basket_conf_data_exp3_diff_ex <- subset(basket_conf_data_exp3_diff, basket_matching_var == "evaluation_ex")
basket_conf_data_exp3_diff_ex <- standardize_vars(basket_conf_data_exp3_diff_ex, vars = c("basket_value_diff", "basket_conf_diff", "basket_value_ex_diff", "basket_value_sd_diff"))

# ex model
bf_diff_ex_exp3 <- bf(confidence_diff ~ 1 + basket_value_diff_s  + basket_conf_diff_s + basket_value_sd_diff_s + (1 + basket_value_diff_s + basket_conf_diff_s + basket_value_sd_diff_s | subject_nr))

brm_diff_exp3_ex_student <- brm(
  bf_diff_ex_exp3,
  data = basket_conf_data_exp3_diff_ex,
  family = student(),
  backend = "cmdstan",
  iter = 4000,
  warmup = 2000,
  ...
  cores = 4,
  threads = threading(3),
  file = here::here("01_analyses/fitted_models/012_brm_diff_exp3_ex_student.rds"),
