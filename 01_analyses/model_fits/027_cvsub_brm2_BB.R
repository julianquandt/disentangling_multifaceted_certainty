...
cvsub_brm2_BB <- kfold(brm2_e1h1_BB, K = 10, folds = basket_conf_data_prereg$fold_pp, save_fits = TRUE)
if(!file.exists(here::here("01_analyses/fitted_models/027_cvsub_brm2_BB_lite.rds"))){
  saveRDS(cvsub_brm2_BB, here::here("01_analyses/fitted_models/027_cvsub_brm2_BB_lite.rds"))
}
