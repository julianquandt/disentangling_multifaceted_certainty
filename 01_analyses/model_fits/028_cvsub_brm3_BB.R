...
cvsub_brm3_BB <- kfold(brm3_e1h1_BB, K = 10, folds = basket_conf_data_prereg$fold_pp, save_fits = TRUE)
if(!file.exists(here::here("01_analyses/fitted_models/028_cvsub_brm3_BB_lite.rds"))){
  saveRDS(cvsub_brm3_BB, here::here("01_analyses/fitted_models/028_cvsub_brm3_BB_lite.rds"))
}
