...
bf1_e1h1_gauss <- bf(confidence_01 ~ confidence_mean_s + value_sd_s
  + (1 + confidence_mean_s + value_sd_s | subject)
  + (1 | stim_name))

brm1_e1h1_gauss <- brm(bf1_e1h1_gauss,
  data = basket_conf_data_prereg,
  family = gaussian(),
  chains = 4, cores = 4, warmup = 2000, iter = 4000,
  backend = "cmdstanr", threads = threading(2),
  seed = 1,
  file = here::here("01_analyses/fitted_models/041_brm1_e1h1_gauss.rds"),
