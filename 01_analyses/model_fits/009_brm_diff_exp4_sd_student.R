...
basket_conf_data_exp4_diff_sd <- subset(basket_conf_data_exp4_diff, basket_matching_var == "rating_sd")
basket_conf_data_exp4_diff_sd <- standardize_vars(basket_conf_data_exp4_diff_sd, vars = c("basket_value_diff", "basket_rating_sd_diff", "basket_value_ex_diff", "basket_value_sd_diff"))

bf_diff_sd_exp4 <- bf(confidence_diff ~ 1 + basket_value_diff_s  + basket_value_ex_diff_s +  basket_value_sd_diff_s + (1 + basket_value_diff_s + basket_value_ex_diff_s +  basket_value_sd_diff_s | subject_nr))

brm_diff_exp4_sd_student <- brm(
  bf_diff_sd_exp4,
  data = basket_conf_data_exp4_diff_sd,
  family = student(),
  backend = "cmdstan",
  iter = 4000,
  warmup = 2000,
  ...
  cores = 4,
  threads = threading(3),
  file = here::here("01_analyses/fitted_models/009_brm_diff_exp4_sd_student.rds"),
