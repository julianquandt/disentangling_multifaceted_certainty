...
cvsub_brm3_BB_cov <- kfold(brm3_e1h1_BB_cov, K = 10, folds = basket_conf_data_prereg$fold_pp, save_fits = TRUE)
if(!file.exists(here::here("01_analyses/fitted_models/032_cvsub_brm3_BB_cov_lite.rds"))){
  saveRDS(cvsub_brm3_BB_cov, here::here("01_analyses/fitted_models/032_cvsub_brm3_BB_cov_lite.rds"))
}
